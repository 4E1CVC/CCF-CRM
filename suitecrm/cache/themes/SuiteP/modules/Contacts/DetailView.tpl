...
{capture name="label" assign="label"}{sugar_translate label='LBL_GOOGLE_MAPS' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{sugar_replace_vars subject='https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=[primary_address_street],[primary_address_city],[primary_address_postalcode],[primary_address_country]&amp;aq=&amp;iwloc=A&amp;output=embed' assign='link'}
