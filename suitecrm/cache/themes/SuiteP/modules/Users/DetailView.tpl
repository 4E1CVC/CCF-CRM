...
{sugar_translate label='LBL_EDITVIEW_PANEL7' module='Users'}
</a>
</li>
<li role="presentation">
...
<img src="index.php?entryPoint=download&id={$fields.id.value}_{$fields.photo.name}{$fields.width.value}&type={$module}" style="max-width: {if !$vardef.width}80{else}200{/if}px;" height="{if !$vardef.height}80{else}50{/if}">
</span>
{/if}
...
{if !$fields.pwd_last_changed.hidden}
{counter name="panelFieldCount" print=false}
