<?php 
 $GLOBALS["dictionary"]["Contact"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Google Maps',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'google_maps_c',
      'vname' => 'LBL_GOOGLE_MAPS',
      'type' => 'iframe',
      'massupdate' => '0',
      'default' => 'https://maps.google.com/maps?f=q&source=s_q&hl=en&geocode=&q={primary_address_street},{primary_address_city},{primary_address_postalcode},{primary_address_country}&aq=&iwloc=A&output=embed',
      'no_default' => false,
      'comments' => '',
      'help' => '',
      'importable' => 'true',
